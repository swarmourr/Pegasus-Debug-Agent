...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./cell_counts.csv", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/cell_counts.csv" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "input",
   ...
   "id": 2,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./carbon_flux", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/carbon_flux" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "input",
 ...
 { "type": "transfer",
   ...
   "id": 4,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./flux_params.yml", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/flux_params.yml" }
   ] }
]
eof
...
cat <<EOF > carbon_flux_carbon_flux-cont.sh
#!/bin/bash
set -e

# setting environment variables for job
EOF
container_env /scratch >> carbon_flux_carbon_flux-cont.sh
cat <<EOF2 >> carbon_flux_carbon_flux-cont.sh
...
pegasus-kickstart  -n carbon_flux -N carbon_flux -R compute  -S @$_CONDOR_SCRATCH_DIR/carbon_flux_carbon_flux.in.lof  -s @$_CONDOR_SCRATCH_DIR/carbon_flux_carbon_flux.out.lof  -L subductcr-end-to-end -T 2026-09-11T05:13:20+00:00 -k 42900 -K 150 ./carbon_flux geochem.csv cell_counts.csv flux_params.yml carbon_flux.tsv
EOF2


chmod +x carbon_flux_carbon_flux-cont.sh
...
shifter --image swarmourr/subductcr-r:latest --volume $PWD:/scratch --workdir=/scratch ./carbon_flux_carbon_flux-cont.sh 
job_ec=$(($job_ec + $?))
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "compute", "url": "file://$PWD/carbon_flux.tsv", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./carbon_flux.tsv" }
   ] }
]
eof
