...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./ARS_trim_R2.fastq.gz", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/ARS_trim_R2.fastq.gz" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "input",
 ...
 { "type": "transfer",
   ...
   "id": 3,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./ARS_trim_R1.fastq.gz", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/ARS_trim_R1.fastq.gz" }
   ] }
]
eof
...
ARS_trim_R2.fastq.gz;;;mifaser;;;ARS_trim_R1.fastq.gz
eof
...
cat <<EOF > mifaser_mifaser_ARS-cont.sh
#!/bin/bash
set -e

# setting environment variables for job
EOF
container_env /scratch >> mifaser_mifaser_ARS-cont.sh
cat <<EOF2 >> mifaser_mifaser_ARS-cont.sh
...
pegasus-kickstart  -n mifaser -N mifaser_ARS -R compute  -S @$_CONDOR_SCRATCH_DIR/mifaser_mifaser_ARS.in.lof  -s @$_CONDOR_SCRATCH_DIR/mifaser_mifaser_ARS.out.lof  -L subductcr-end-to-end -T 2026-09-11T05:13:20+00:00 -k 42900 -K 150 ./mifaser ARS_trim_R1.fastq.gz ARS_trim_R2.fastq.gz ARS_enzymes.tsv
EOF2


chmod +x mifaser_mifaser_ARS-cont.sh
...
shifter --image swarmourr/subductcr-mifaser:latest --volume $PWD:/scratch --workdir=/scratch ./mifaser_mifaser_ARS-cont.sh 
job_ec=$(($job_ec + $?))
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "compute", "url": "file://$PWD/ARS_enzymes.tsv", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./ARS_enzymes.tsv" }
   ] }
]
eof
