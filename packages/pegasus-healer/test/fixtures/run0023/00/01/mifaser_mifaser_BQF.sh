...
[
 ...
 { "type": "transfer",
   ...
   "id": 2,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./BQF_trim_R1.fastq.gz", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/BQF_trim_R1.fastq.gz" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "input",
   ...
   "id": 3,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./BQF_trim_R2.fastq.gz", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/BQF_trim_R2.fastq.gz" }
   ] }
]
eof
...
mifaser;;;BQF_trim_R1.fastq.gz;;;BQF_trim_R2.fastq.gz
eof
...
cat <<EOF > mifaser_mifaser_BQF-cont.sh
#!/bin/bash
set -e

# setting environment variables for job
EOF
container_env /scratch >> mifaser_mifaser_BQF-cont.sh
cat <<EOF2 >> mifaser_mifaser_BQF-cont.sh
...
pegasus-kickstart  -n mifaser -N mifaser_BQF -R compute  -S @$_CONDOR_SCRATCH_DIR/mifaser_mifaser_BQF.in.lof  -s @$_CONDOR_SCRATCH_DIR/mifaser_mifaser_BQF.out.lof  -L subductcr-end-to-end -T 2026-09-11T05:13:20+00:00 -k 42900 -K 150 ./mifaser BQF_trim_R1.fastq.gz BQF_trim_R2.fastq.gz BQF_enzymes.tsv
EOF2


chmod +x mifaser_mifaser_BQF-cont.sh
...
shifter --image swarmourr/subductcr-mifaser:latest --volume $PWD:/scratch --workdir=/scratch ./mifaser_mifaser_BQF-cont.sh 
job_ec=$(($job_ec + $?))
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "compute", "url": "file://$PWD/BQF_enzymes.tsv", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./BQF_enzymes.tsv" }
   ] }
]
eof
