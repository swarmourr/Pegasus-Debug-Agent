...
[
 ...
 { "type": "transfer",
   ...
   "id": 2,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./PFF_trim_R1.fastq.gz", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/PFF_trim_R1.fastq.gz" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "input",
   ...
   "id": 3,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./PFF_trim_R2.fastq.gz", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/PFF_trim_R2.fastq.gz" }
   ] }
]
eof
...
mifaser;;;PFF_trim_R1.fastq.gz;;;PFF_trim_R2.fastq.gz
eof
...
cat <<EOF > mifaser_mifaser_PFF-cont.sh
#!/bin/bash
set -e

# setting environment variables for job
EOF
container_env /scratch >> mifaser_mifaser_PFF-cont.sh
cat <<EOF2 >> mifaser_mifaser_PFF-cont.sh
...
pegasus-kickstart  -n mifaser -N mifaser_PFF -R compute  -S @$_CONDOR_SCRATCH_DIR/mifaser_mifaser_PFF.in.lof  -s @$_CONDOR_SCRATCH_DIR/mifaser_mifaser_PFF.out.lof  -L subductcr-end-to-end -T 2026-09-11T05:13:20+00:00 -k 42900 -K 150 ./mifaser PFF_trim_R1.fastq.gz PFF_trim_R2.fastq.gz PFF_enzymes.tsv
EOF2


chmod +x mifaser_mifaser_PFF-cont.sh
...
shifter --image swarmourr/subductcr-mifaser:latest --volume $PWD:/scratch --workdir=/scratch ./mifaser_mifaser_PFF-cont.sh 
job_ec=$(($job_ec + $?))
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "compute", "url": "file://$PWD/PFF_enzymes.tsv", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./PFF_enzymes.tsv" }
   ] }
]
eof
