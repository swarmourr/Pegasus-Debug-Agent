...
[
 ...
 { "type": "transfer",
   ...
   "id": 2,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./PGF_trim_R2.fastq.gz", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/PGF_trim_R2.fastq.gz" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "input",
   ...
   "id": 3,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./PGF_trim_R1.fastq.gz", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/PGF_trim_R1.fastq.gz" }
   ] }
]
eof
...
mifaser;;;PGF_trim_R2.fastq.gz;;;PGF_trim_R1.fastq.gz
eof
...
cat <<EOF > mifaser_mifaser_PGF-cont.sh
#!/bin/bash
set -e

# setting environment variables for job
EOF
container_env /scratch >> mifaser_mifaser_PGF-cont.sh
cat <<EOF2 >> mifaser_mifaser_PGF-cont.sh
...
pegasus-kickstart  -n mifaser -N mifaser_PGF -R compute  -S @$_CONDOR_SCRATCH_DIR/mifaser_mifaser_PGF.in.lof  -s @$_CONDOR_SCRATCH_DIR/mifaser_mifaser_PGF.out.lof  -L subductcr-end-to-end -T 2026-09-11T05:13:20+00:00 -k 42900 -K 150 ./mifaser PGF_trim_R1.fastq.gz PGF_trim_R2.fastq.gz PGF_enzymes.tsv
EOF2


chmod +x mifaser_mifaser_PGF-cont.sh
...
shifter --image swarmourr/subductcr-mifaser:latest --volume $PWD:/scratch --workdir=/scratch ./mifaser_mifaser_PGF-cont.sh 
job_ec=$(($job_ec + $?))
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "compute", "url": "file://$PWD/PGF_enzymes.tsv", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./PGF_enzymes.tsv" }
   ] }
]
eof
