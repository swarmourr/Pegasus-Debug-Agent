...
[
 ...
 { "type": "transfer",
   ...
   "id": 2,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./SLF_trim_R1.fastq.gz", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/SLF_trim_R1.fastq.gz" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "input",
   ...
   "id": 3,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./SLF_trim_R2.fastq.gz", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/SLF_trim_R2.fastq.gz" }
   ] }
]
eof
...
mifaser;;;SLF_trim_R1.fastq.gz;;;SLF_trim_R2.fastq.gz
eof
...
cat <<EOF > mifaser_mifaser_SLF-cont.sh
#!/bin/bash
set -e

# setting environment variables for job
EOF
container_env /scratch >> mifaser_mifaser_SLF-cont.sh
cat <<EOF2 >> mifaser_mifaser_SLF-cont.sh
...
pegasus-kickstart  -n mifaser -N mifaser_SLF -R compute  -S @$_CONDOR_SCRATCH_DIR/mifaser_mifaser_SLF.in.lof  -s @$_CONDOR_SCRATCH_DIR/mifaser_mifaser_SLF.out.lof  -L subductcr-end-to-end -T 2026-09-11T05:13:20+00:00 -k 42900 -K 150 ./mifaser SLF_trim_R1.fastq.gz SLF_trim_R2.fastq.gz SLF_enzymes.tsv
EOF2


chmod +x mifaser_mifaser_SLF-cont.sh
...
shifter --image swarmourr/subductcr-mifaser:latest --volume $PWD:/scratch --workdir=/scratch ./mifaser_mifaser_SLF-cont.sh 
job_ec=$(($job_ec + $?))
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "compute", "url": "file://$PWD/SLF_enzymes.tsv", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./SLF_enzymes.tsv" }
   ] }
]
eof
