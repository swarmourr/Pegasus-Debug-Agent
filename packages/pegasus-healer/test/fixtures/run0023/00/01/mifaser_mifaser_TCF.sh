...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./TCF_trim_R1.fastq.gz", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/TCF_trim_R1.fastq.gz" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "input",
 ...
 { "type": "transfer",
   ...
   "id": 3,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./TCF_trim_R2.fastq.gz", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/TCF_trim_R2.fastq.gz" }
   ] }
]
eof
...
TCF_trim_R1.fastq.gz;;;mifaser;;;TCF_trim_R2.fastq.gz
eof
...
cat <<EOF > mifaser_mifaser_TCF-cont.sh
#!/bin/bash
set -e

# setting environment variables for job
EOF
container_env /scratch >> mifaser_mifaser_TCF-cont.sh
cat <<EOF2 >> mifaser_mifaser_TCF-cont.sh
...
pegasus-kickstart  -n mifaser -N mifaser_TCF -R compute  -S @$_CONDOR_SCRATCH_DIR/mifaser_mifaser_TCF.in.lof  -s @$_CONDOR_SCRATCH_DIR/mifaser_mifaser_TCF.out.lof  -L subductcr-end-to-end -T 2026-09-11T05:13:20+00:00 -k 42900 -K 150 ./mifaser TCF_trim_R1.fastq.gz TCF_trim_R2.fastq.gz TCF_enzymes.tsv
EOF2


chmod +x mifaser_mifaser_TCF-cont.sh
...
shifter --image swarmourr/subductcr-mifaser:latest --volume $PWD:/scratch --workdir=/scratch ./mifaser_mifaser_TCF-cont.sh 
job_ec=$(($job_ec + $?))
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "compute", "url": "file://$PWD/TCF_enzymes.tsv", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./TCF_enzymes.tsv" }
   ] }
]
eof
