...
[
 ...
 { "type": "transfer",
   ...
   "id": 2,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./clique_geochem", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/clique_geochem" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "input",
   ...
   "id": 3,
   "src_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./asv_cliques.rds", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file://$PWD/asv_cliques.rds" }
   ] }
]
eof
...
cat <<EOF > clique_geochem_clique_geochem-cont.sh
#!/bin/bash
set -e

# setting environment variables for job
EOF
container_env /scratch >> clique_geochem_clique_geochem-cont.sh
cat <<EOF2 >> clique_geochem_clique_geochem-cont.sh
...
pegasus-kickstart  -n clique_geochem -N clique_geochem -R compute  -S @$_CONDOR_SCRATCH_DIR/clique_geochem_clique_geochem.in.lof  -s @$_CONDOR_SCRATCH_DIR/clique_geochem_clique_geochem.out.lof  -L subductcr-end-to-end -T 2026-09-11T05:13:20+00:00 -k 42900 -K 150 ./clique_geochem asv_cliques.rds geochem.csv asv_clique_env.tsv
EOF2


chmod +x clique_geochem_clique_geochem-cont.sh
...
shifter --image swarmourr/subductcr-r:latest --volume $PWD:/scratch --workdir=/scratch ./clique_geochem_clique_geochem-cont.sh 
job_ec=$(($job_ec + $?))
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "compute", "url": "file://$PWD/asv_clique_env.tsv", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "compute", "url": "file:///pscratch/sd/h/hsafri/wf-scratch/hsafri/pegasus/subductcr-end-to-end/run0023/./asv_clique_env.tsv" }
   ] }
]
eof
